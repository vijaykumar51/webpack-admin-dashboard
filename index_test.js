...
class WebpackAdminDashboard {
	apply(compiler) {
		...
		compiler.plugin("emit", (compilation, callback) => {
			...
			console.log(Object.keys(stats.entrypoints));
			var ep = Object.keys(stats.entrypoints);
			console.log(stats.entrypoints[ep[0]].assets);
			console.log(stats.entrypoints[ep[1]].assets);
